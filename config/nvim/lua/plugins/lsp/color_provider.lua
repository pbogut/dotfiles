...
local buf_set_highlights_debounce, timer_set =
  require('utils').debounce_trailing(buf_set_highlights, 250, false)
...
function M.buf_attach(bufnr, options)
  ...
  local trigger_update_highlight, timer =
    require('utils').debounce_trailing(M.update_highlight, options.debounce or 200, false)
