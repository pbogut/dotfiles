...
files="screenrc xkb vimrc zshrc zshrc.d tmux tmux.conf yaourtrc ackrc scripts gitconfig githelpers screen-256color.ti weechat/cron.txt weechat/alias.conf weechat/weechat.conf config/nvim/init.vim config/roxterm.sourceforge.net config/autostart/autostart.desktop config/autostart/rescuetime.desktop vim/bundle/Vundle.vim"    # list of files/folders to symlink in homedir
