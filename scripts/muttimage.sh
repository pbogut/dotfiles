...
convert $1 -resize $((px_width))x$((px_height))\> -background darkslategrey -gravity center -extent $((px_width))x$((px_height)) "$1.resized" &&
### Display Image / offset with mutt bar
echo -e "2;3;\n0;1;210;20;$px_width;$px_height;0;0;0;0;$1.resized\n4;\n3;" |  /usr/lib/w3m/w3mimgdisplay &
